...
async function getDashboardData() {
  ...
  const [totalPacientes, consultasActivas, nuevosHoy, casosUrgentes, recientes] =
    await Promise.all([
      ...
      prisma.consultas.count({ where: { medico_id: MEDICO_ID, estado: "en_curso" } }),
      prisma.pacientes.count({ where: { medico_id: MEDICO_ID, created_at: { gte: hoy } } }),
      prisma.consultas.count({ where: { medico_id: MEDICO_ID, alarma: true, estado: "en_curso" } }),
  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-[#64748B] mt-1">Bienvenido, Dr. Mazza</p>
      </div>
